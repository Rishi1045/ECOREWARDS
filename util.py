...
# Load YOLOv8 model
yolo_model = YOLO('YOLO/streamlit-detection-tracking - app/weights/best.pt')
...
def classify_waste_bytes(image_bytes):
    global model, output_class
...
def process_multi_waste_image(image_data):
    """
    Process an image using YOLOv8 model for multi-waste detection
    """
    try:
        ...
        if isinstance(image_data, str):
            ...
            # If image_data is bytes or file object
